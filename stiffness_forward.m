function B = stiffness_forward( T , dt , dx, dy)
...
%Corner Node D - Now bulk
B(y,1) = ...
    -k_liquid*(T(y,2)-T(y,1))*dy/dx...
    -k_liquid*(T(y,2)-T(y,3))*dy/dx...
    -k_liquid*(T(y-1,1)-T(y-2,1))*dx/dy...
    -k_liquid*(T(y-1,1)-T(y,1))*dx/dy;
B(y,1) = B(y,1)/coef + T(y,1);

%Equation 1 + Column left of 1
for i=2:y-1
    B(i,x) = ...
    ...
    B(i,x-1) = ...
        -k_liquid*(T(i,x-1)-T(i,x-2))*dy/dx...
        -k_liquid*(T(i,x-1)-T(i,x))*dy/dx...
        -k_liquid*(T(i,x-1)-T(i-1,x-1))*dx/dy...
        -k_liquid*(T(i,x-1)-T(i+1,x-1))*dx/dy;
    B(i,x-1) = B(i,x-1)/coef + T(i,x-1);
end
    
%Equation 2 + 3 + Row below 3
for i=2:x-1
    B(y,i) = ...
    ...
    B(2,i) = ...
        -k_liquid*(T(2,i)-T(2,i-1))*dy/dx...
        -k_liquid*(T(2,i)-T(2,i+1))*dy/dx...
        -k_liquid*(T(2,i)-T(1,i))*dx/dy...
        -k_liquid*(T(2,i)-T(3,i))*dx/dy;
    B(2,i) = B(2,i)/coef + T(2,i);
end

%Node(2,1)
B(2,1) = ...
    -2*k_liquid*(T(2,1)-T(2,2))*dy/dx...
    -k_liquid*(T(2,1)-T(3,1))*dx/dy...
    -k_liquid*(T(2,1)-T(1,1))*dx/dy;
B(2,1) = B(2,1)/coef + T(2,1);
